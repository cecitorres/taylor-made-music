    ...
    return (
        <section className="relative flex flex-col items-center justify-center w-full py-10 text-white h-96">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
                <Typography variant="h2">Taylor Made Music</Typography>
                <Typography variant="h5" className="my-4">We are a team of passionate musicians who are dedicated to teaching music to children and adults.</Typography>
                
                <div className="grid w-full grid-cols-4 gap-4 px-8 mt-4">
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <Typography variant="h5">Students Taught</Typography> 
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        <div className="flex items-center justify-center w-24 h-24 mb-2 rounded-full bg-white/30">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <Typography variant="h5">Lessons Taught Each Year</Typography> 
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        <div className="flex items-center justify-center w-24 h-24 mb-2 rounded-full bg-white/30">
